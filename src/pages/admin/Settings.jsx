    ...
    const loadSettings = async () => {
      ...
      try {
        ...
        if (!response.ok || !data.success) {
          throw new Error(
            data.message || "Unable to load system settings."
          );
        }
        ...
        // Try local backup
        try {
          const savedSettings = localStorage.getItem("vsamsSettings");
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updatedSettings = {
        ...
        workingDays: {
          ...DEFAULT_SETTINGS.workingDays,
          ...((data.settings || settings).workingDays || {}),
        },
      };
              ...
              <div className="mb-8 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 max-w-2xl text-sm leading-6 text-slate-500">
                    Configure the normal operating schedule used by the
                    attendance system.
                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 max-w-lg text-xs leading-5 text-slate-500">
                        Staff who sign in after this time will automatically
                        be recorded as late.
                      </p>
                    </div>
              ...
              <div className="mt-8">
                ...
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                  ...
                  {WORKING_DAYS.map((day) => {
                    const enabled = settings.workingDays[day];
            ...
            <div className="p-6 sm:p-8 lg:p-10">
              ...
              <div className="mb-8 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 max-w-2xl text-sm leading-6 text-slate-500">
                    These times are used by VSAMS when processing staff
                    attendance records.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                  ...
                  <div className="mt-4 flex items-start gap-2 rounded-xl bg-orange-50 p-3">
                    ...
                    <p className="text-xs leading-5 text-orange-700">
                      Staff signing out before{" "}
                      <strong>
                        {settings.signOutTime}
                      </strong>{" "}
                      can be identified as leaving early.
                    </p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 max-w-3xl text-xs leading-5 text-amber-700">
                      If a staff member signs in but does not complete a
                      sign-out, the attendance record remains incomplete.
                      This allows the administrator to identify missing
                      sign-out records.
                    </p>
                  </div>
            ...
            <div className="p-6 sm:p-8 lg:p-10">
              ...
              <div className="mb-8 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 max-w-2xl text-sm leading-6 text-slate-500">
                    Technical information and security details for the
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 max-w-3xl text-xs leading-5 text-blue-700">
                      Attendance times are controlled by the server to
                      prevent staff from manually changing attendance
                      timestamps. Staff accounts are created and managed
